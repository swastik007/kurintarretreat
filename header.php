                                ...
                                <?php
                                    wp_nav_menu(
                                        array(
                                            ...
                                            'container'      => 'ul',
                                            'menu_class'     => 'w-full lg:flex lg:items-center lg:w-auto hidden lg:block p-5 lg:p-0 lunum-header md:ml-auto md:mr-0 text-base md:text-sm lg:text-lg xl:text-xl absolute lg:static left-0 top-20 ',
                                        )
                                    );
                                ?>
                                </nav>
