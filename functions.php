...
function video_post() {
	...
	function theme_stylescript() {
		...
		wp_enqueue_style( 'styles', $theme_uri . '/assets/vendor/css/style.css', array(), '0.9.8' );
		wp_enqueue_style( 'kurintarretreat_css', $theme_uri . '/assets/css/theme.css', array(), '0.4.4' );
		//lity code
