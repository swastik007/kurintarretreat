...
Come raise a glass where culture and creativity pour into every drink.
    ...
    <div class="event-slider owl-carousel owl-theme">
      ...
      <div class="item">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/bar-image00.jpg" alt="Event 2" class="img-fluid rounded shadow-sm">
      </div>
      <div class="item">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/bar-image02.jpg" alt="Event 3" class="img-fluid rounded shadow-sm">
      </div>
    </div>
    </div>
